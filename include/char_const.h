...
//static const char TCONST_fquicklist[] PROGMEM = "/fquicklist.json";       // file used via xload to display a dropdown list in WebUI block-effects-config page if /fslowlist.json does not exist, generated in block_effects_config()
//static const char TCONST_fslowlist[] PROGMEM = "/fslowlist.json";         // file used via xload to display a dropdown list in WebUI via delayed call, created in delayedcall_show_effects()
...
//static const char TCONST_quicklist[] PROGMEM = "/quicklist.json";       // file used via xload to display a dropdown list in WebUI if /fslowlist.json does not exist, generated in block_effects_main()
