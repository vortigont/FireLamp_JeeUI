...
static const char TINTF_in_sel_lst[] PROGMEM = "В загальному переліку";
static const char TINTF_in_demo[] PROGMEM = "В переліку Демо'";
...
static const char TINTF_effrename[] PROGMEM = "Назва ефекту";
