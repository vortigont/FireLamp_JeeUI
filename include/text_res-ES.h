...
static const char TINTF_in_sel_lst[] PROGMEM = "Presencia en lista de Efectos";
static const char TINTF_in_demo[] PROGMEM = "Presencia en lista demo";
...
static const char TINTF_effrename[] PROGMEM = "Nombre de efecto";
