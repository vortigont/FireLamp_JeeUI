 ...
 */
static constexpr const char* TEFF_blank = "Nero";  // пустой эффект, темный экран
...
static constexpr const char* TINTF_ButtonEncoder = "Boton / Encoder";
...
static constexpr const char* TINTF_Rand = "El Azar.";
...
static constexpr const char* TINTF_copy_effect = "Copy effect";
