 ...
 */
static constexpr const char* TEFF_blank = "Пустота";  // пустой эффект, темный экран
...
static constexpr const char* TEFF_078 = "Частотный анализатор";
static constexpr const char* TEFF_079 = "Осциллограф";
...
static constexpr const char* TINTF_0B4 = "Сбросить параметры эффекта";
static constexpr const char* TINTF_0B5 = "Удалить из списка выбора";
...
static constexpr const char* TINTF_Rand = "Случ.";
...
static constexpr const char* TINTF_copy_effect = "Скопировать эффект";
