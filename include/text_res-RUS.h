...
static const char TINTF_in_sel_lst[] PROGMEM = "Включен в список выбора";
static const char TINTF_in_demo[] PROGMEM = "Включен в Демо";
...
static const char TINTF_effrename[] PROGMEM = "Переименовать эффект";
...
static const char TINTF_ledstrip[] PROGMEM = "Топология LED ленты";
static const char TINTF_f_restore_state[] PROGMEM = "Восстанавливать состояние при включении";
