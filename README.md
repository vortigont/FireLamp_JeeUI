...
### WiKi проекта
Дополнительную информацию и документацию по проекту можно найти в [WiKi](https://github.com/vortigont/EmbUI/wiki)
...
> [!NOTE]
> После отказа от платформы 8266 билдер более не поддерживается и может работать некорректно. Рекоммендуется использовать сборку через платформио.
