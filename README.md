...
Последний стабильно работающий на контроллерах 8266 выпуск проекта - версия v3.1.1 в ветке [compat_8266](../../tree/compat_8266), прочий код в ветке [legacy](../../tree/legacy).
