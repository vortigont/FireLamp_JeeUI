...
static constexpr const char* T_font_txt = "font_txt";
...
static constexpr const char* T_cnt = "cnt";
...
static constexpr const char* T_description = "description";
static constexpr const char* T_destination = "destination";
